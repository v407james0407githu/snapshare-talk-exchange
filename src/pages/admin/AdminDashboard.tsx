  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        <KpiCard title="今日新會員" value={stats.todayUsers.toLocaleString()} subtitle={`累計 ${stats.totalUsers.toLocaleString()}`} icon={<Users className="h-4 w-4" />} loading={loading} />
        <KpiCard title="今日新作品" value={stats.todayPhotos.toLocaleString()} subtitle={`累計 ${stats.totalPhotos.toLocaleString()}`} icon={<Image className="h-4 w-4" />} loading={loading} />
        <KpiCard title="今日新討論" value={stats.todayTopics.toLocaleString()} subtitle={`累計 ${stats.totalTopics.toLocaleString()}`} icon={<MessageSquare className="h-4 w-4" />} loading={loading} />
        <KpiCard title="今日新刊登" value={stats.todayListings.toLocaleString()} subtitle={`累計 ${stats.totalListings.toLocaleString()}`} icon={<Store className="h-4 w-4" />} loading={loading} />
        <KpiCard title="今日瀏覽量" value={stats.todayViews.toLocaleString()} icon={<Eye className="h-4 w-4" />} loading={loading} />
      </div>

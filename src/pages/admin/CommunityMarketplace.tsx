    ...
    <>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
        <div className="bg-card border rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold">{totalMain}</p>
            <p className="text-xs text-muted-foreground">主分類</p>
          </div>
        </div>
        <div className="bg-card border rounded-xl p-4 flex items-center gap-3">
          <div className="p-2 rounded-lg bg-muted">
          ...
          <div>
            <p className="text-2xl font-bold">{totalSub}</p>
            <p className="text-xs text-muted-foreground">子分類</p>
          </div>
        </div>
        <div className="bg-card border rounded-xl p-4 flex items-center gap-3">
          <div className="p-2 rounded-lg bg-muted">
                ...
                <CardContent className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="text-xs text-muted-foreground">
                      slug: {cat.slug} · 排序: {cat.sort_order} · {getChildren(cat.id).length} 個子分類
                    </span>
                  </div>
                  <div className="flex gap-2 shrink-0">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (confirm("確定刪除？子分類也會一併刪除")) deleteMutation.mutate(cat.id);
                      }}
                    >
                      ...
                      <CardContent className="flex items-center gap-3 p-3">
                        ...
                        <div className="flex gap-2 shrink-0">
                          ...
                          <Button
                            ...
                            className="text-destructive"
                            onClick={() => {
                              if (confirm("確定刪除？")) deleteMutation.mutate(sub.id);
                            }}
                          >
